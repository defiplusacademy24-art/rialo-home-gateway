        ...
        {open && (
          <>
            ...
            <motion.div
              ...
              className="fixed inset-x-3 top-14 sm:absolute sm:inset-x-auto sm:right-0 sm:top-full sm:mt-2 w-auto sm:w-80 max-h-[420px] bg-card border border-border rounded-2xl shadow-xl z-50 overflow-hidden"
            >
